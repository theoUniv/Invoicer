  ...
  return (
    <header className="absolute w-full flex justify-between items-center px-12 py-9 border-b border-[rgba(26,24,23,0.12)]">
      ...
      <nav className="flex gap-8">
        <Link href="/home" className="text-[#1A1817] text-xs uppercase tracking-[0.05em]">
          {t('dashboard.myFiles')}
        </Link>
        <Link href="/overview" className="text-[#8A8580] text-xs uppercase tracking-[0.05em] hover:text-[#1A1817] transition-colors">
